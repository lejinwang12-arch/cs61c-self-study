...
mapLoop:
    lw t1, 0(s0)      ##1 load the address of the array of current node into t1
    lw t2, 4(s0)        # load the size of the node's array into t2

    slli t3, t0, 2
    add t1, t1, t3      ##2 offset the array address by the count
    ...
    lw a0, 8(s0)        ##4 load the address of the next node into a0
